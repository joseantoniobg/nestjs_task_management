...
let TasksController = class TasksController {
    ...
    updateTaskStatus(user, id, status) {
...
__decorate([
    ...
    __param(0, get_user_decorator_1.GetUser()), __param(1, common_1.Param('id', common_1.ParseIntPipe)), __param(2, common_1.Body('status', task_status_validation_pipe_1.TaskStatusValidationPipe)),
    __metadata("design:type", Function),
...
__decorate([
    common_1.Delete('/:id'),
    __param(0, get_user_decorator_1.GetUser()), __param(1, common_1.Param('id', common_1.ParseIntPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [user_entity_1.User, Number]),
    __metadata("design:returntype", Promise)
